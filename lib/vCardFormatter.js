    ...
    module.exports = {
        ...
        getFormattedString: function(vCard) {
            ...
            if (vCard.adr && typeof vCard.adr === 'object' ) {
                ...
                vCard.adr = (vCard.adr.length) ? vCard.adr : [vCard.adr];  
                vCard.adr.forEach(
                    function(address) {
            ...
            if (vCard.tel && typeof vCard.tel === 'object' ) {
                ...
                vCard.tel = (vCard.tel.length) ? vCard.tel : [vCard.tel];  
            ...
            if (vCard['x-socialprofile'] && typeof vCard['x-socialprofile'] === 'object') {

                vCard['x-socialprofile'] = (vCard['x-socialprofile'].length) ? vCard['x-socialprofile'] : [vCard['x-socialprofile']];  
